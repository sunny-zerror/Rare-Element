        ...
        <>
            <div className="products_hero-section ">
                ...
                <div className="products_content padding">
                    <h2 className='text-2xl'>Aurora Drop Earrings</h2>
            ...
            <div className="products_header">
                <p className="products_subtitle text-xl uppercase">Crafted for Every Moment</p>
                <h2 className="products_title text-4xl">Rings</h2>
            </div>
